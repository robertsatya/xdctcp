...
l = listdir('/usr/local/home/cse222a19/ucsdcse222a/group19/src/sim1_1123/')
...
p_list = []
for file_name in l:
    with open('/usr/local/home/cse222a19/ucsdcse222a/group19/src/sim1_1123/' + file_name, 'r') as f:
        s = f.read()
