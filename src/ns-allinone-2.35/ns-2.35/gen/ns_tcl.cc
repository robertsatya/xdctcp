...
Agent/TCPX set maxburst_ 0\n\
Agent/TCPX set aggressive_maxburst_ 1 ;  # Added 2003/6/2.\n\
Agent/TCPX set maxcwnd_ 0\n\
Agent/TCPX set numdupacks_ 3\n\
Agent/TCPX set numdupacksFrac_ -1 ;	# Added 2002/10/18.\n\
Agent/TCPX set exitFastRetrans_ true ;	# Added 2003/7/28.\n\
Agent/TCPX set window_ 20\n\
Agent/TCPX set windowInit_ 2 ;		# default changed on 2001/5/26.\n\
Agent/TCPX set windowInitOption_ 1\n\
Agent/TCPX set syn_ true ;		# default changed on 2001/5/17.\n\
Agent/TCPX set max_connects_ -1 ;	# Variable added on 2007/9/25.\n\
Agent/TCPX set windowOption_ 1\n\
Agent/TCPX set windowConstant_ 4\n\
Agent/TCPX set windowThresh_ 0.002\n\
Agent/TCPX set decrease_num_ 0.5\n\
Agent/TCPX set increase_num_ 1.0\n\
Agent/TCPX set k_parameter_ 0.0 ;	# for binomial congestion control\n\
Agent/TCPX set l_parameter_ 1.0 ;  	# for binomial congestion control\n\
Agent/TCPX set overhead_ 0\n\
Agent/TCPX set ecn_ 0\n\
Agent/TCPX set old_ecn_ 0\n\
Agent/TCPX set bugfix_ss_ 1 ;		# Variable added on 2006/06/13\n\
Agent/TCPX set packetSize_ 1000\n\
Agent/TCPX set tcpip_base_hdr_size_ 40\n\
Agent/TCPX set ts_option_size_ 10; 	# in bytes\n\
Agent/TCPX set bugFix_ true\n\
Agent/TCPX set bugFix_ack_ false ;       # Variable added on 2003/08/13\n\
Agent/TCPX set bugFix_ts_ false ;	# Variable added on 2003/08/13\n\
Agent/TCPX set lessCareful_ false ;	# for the Less Careful variant of\n\
Agent/TCPX set timestamps_ false\n\
Agent/TCPX set ts_resetRTO_ false ;	# Added 2003/07/24.\n\
Agent/TCPX set slow_start_restart_ true\n\
Agent/TCPX set restart_bugfix_ true\n\
Agent/TCPX set tcpTick_ 0.01 ;		# default changed on 2002/03/07\n\
Agent/TCPX set maxrto_ 60 ; 		# default changed on 2007/03/28\n\
Agent/TCPX set minrto_ 0.2 ;		# Default changed to 200ms on \n\
Agent/TCPX set srtt_init_ 0\n\
Agent/TCPX set rttvar_init_ 12\n\
Agent/TCPX set rtxcur_init_ 3.0 ;	# Default changed on 2006/01/21		\n\
Agent/TCPX set T_SRTT_BITS 3\n\
Agent/TCPX set T_RTTVAR_BITS 2\n\
Agent/TCPX set rttvar_exp_ 2\n\
Agent/TCPX set updated_rttvar_ true ;	# Variable added on 2006/1/21\n\
Agent/TCPX set timerfix_ true ; 		# Variable added on 2001/05/11\n\
Agent/TCPX set rfc2988_ true ;		# Default set to \"true\" on 2002/03/07.\n\
Agent/TCPX instproc done {} { }\n\
Agent/TCPX set noFastRetrans_ false\n\
Agent/TCPX set partial_ack_ false ;	# Variable added on 2002/12/28.\n\
Agent/TCPX set dupacks_ 0\n\
Agent/TCPX set ack_ 0\n\
Agent/TCPX set cwnd_ 0\n\
Agent/TCPX set awnd_ 0\n\
Agent/TCPX set ssthresh_ 0\n\
Agent/TCPX set rtt_ 0\n\
Agent/TCPX set srtt_ 0\n\
Agent/TCPX set rttvar_ 0\n\
Agent/TCPX set backoff_ 0\n\
Agent/TCPX set maxseq_ 0\n\
Agent/TCPX set singledup_ 1 ;		# default changed on 2001/11/28.\n\
Agent/TCPX set LimTransmitFix_ false ;	# added on 2003/03/31.\n\
Agent/TCPX set precisionReduce_ true ;	# default changed on 2006/1/24.\n\
Agent/TCPX set oldCode_ false\n\
Agent/TCPX set useHeaders_ true ;	# default changed on 2001/11/28. \n\
\n\
Agent/TCPX set low_window_ 38 ;		# default changed on 2002/8/12.		\n\
Agent/TCPX set high_window_ 83000\n\
Agent/TCPX set high_p_ 0.0000001\n\
Agent/TCPX set high_decrease_ 0.1\n\
Agent/TCPX set max_ssthresh_ 0\n\
Agent/TCPX set cwnd_range_ 0 ;		# cwnd_frac_ deleted on 6/6/04,\n\
Agent/TCPX set rate_request_ 0\n\
Agent/TCPX set qs_enabled_ false\n\
Agent/TCPX set tcp_qs_recovery_ true ;	# Added on 2004/09/21, by Pasi.\n\
Agent/TCPX set qs_request_mode_ 1\n\
Agent/TCPX set qs_rtt_ 50\n\
Agent/TCPX set print_request_ false\n\
Agent/TCPX set qs_thresh_ 4\n\
\n\
Agent/TCPX set ndatapack_ 0\n\
Agent/TCPX set ndatabytes_ 0\n\
Agent/TCPX set nackpack_ 0\n\
Agent/TCPX set nrexmit_ 0\n\
Agent/TCPX set nrexmitpack_ 0\n\
Agent/TCPX set nrexmitbytes_ 0\n\
Agent/TCPX set necnresponses_ 0\n\
Agent/TCPX set ncwndcuts_ 0 \n\
Agent/TCPX set ncwndcuts1_ 0\n\
\n\
Agent/TCPX set trace_all_oneline_ false\n\
\n\
Agent/TCPX set QOption_ 0 \n\
Agent/TCPX set EnblRTTCtr_ 0\n\
Agent/TCPX set control_increase_ 0\n\
\n\
Agent/TCPX set SetCWRonRetransmit_ true ; # added on 2005/06/19.\n\
Agent/TCPX set dctcp_ false;\n\
Agent/TCPX set dctcp_alpha_ 0.0;\n\
Agent/TCPX set dctcp_g_ 0.0625;\n\
Agent/TCP set nam_tracevar_ false\n\
Agent/TCPX set nam_tracevar_ false\n\
\n\
...
\n\
Agent/TCPX set eln_ 0\n\
Agent/TCPX set eln_rxmit_thresh_ 1\n\
Agent/TCPX set delay_growth_ true ;	# default changed on 2001/5/17.\n\
\n\
Agent/TCPX set CoarseTimer_      0\n\
\n\
Agent/TCPX set frto_enabled_	0 ;	# Added on 2004/10/26 for F-RTO\n\
Agent/TCPX set sfrto_enabled_	0 ;	# Added on 2004/10/26 for F-RTO\n\
Agent/TCPX set spurious_response_ 1 ;	# Added on 2004/10/26 for F-RTO\n\
\n\
...
Agent/TCPX/FullTcpX instproc done_data {} { }\n\
\n\
...
\n\
if [TclObject is-class Agent/TCPX/FullTcpX] {\n\
Agent/TCPX/FullTcpX set segsperack_ 1; # ACK frequency\n\
Agent/TCPX/FullTcpX set spa_thresh_ 0; # below do 1 seg per ack [0:disable]\n\
Agent/TCPX/FullTcpX set segsize_ 536; # segment size\n\
Agent/TCPX/FullTcpX set tcprexmtthresh_ 3; # num dupacks to enter recov\n\
Agent/TCPX/FullTcpX set iss_ 0; # Initial send seq#\n\
Agent/TCPX/FullTcpX set nodelay_ false; # Nagle disable?\n\
Agent/TCPX/FullTcpX set data_on_syn_ false; # allow data on 1st SYN?\n\
Agent/TCPX/FullTcpX set dupseg_fix_ true ; # no rexmt w/dup segs from peer\n\
Agent/TCPX/FullTcpX set dupack_reset_ false; # exit recov on ack < highest\n\
Agent/TCPX/FullTcpX set interval_ 0.1 ; # delayed ACK interval 100ms \n\
Agent/TCPX/FullTcpX set close_on_empty_ false; # close conn if sent all\n\
Agent/TCPX/FullTcpX set signal_on_empty_ false; # signal if sent all\n\
Agent/TCPX/FullTcpX set ts_option_size_ 10; # in bytes\n\
Agent/TCPX/FullTcpX set reno_fastrecov_ true; # fast recov true by default\n\
Agent/TCPX/FullTcpX set pipectrl_ false; # use \"pipe\" ctrl\n\
Agent/TCPX/FullTcpX set open_cwnd_on_pack_ true; # ^ win on partial acks?\n\
Agent/TCPX/FullTcpX set halfclose_ false; # do simplex closes (shutdown)?\n\
Agent/TCPX/FullTcpX set nopredict_ false; # disable header prediction code?\n\
Agent/TCPX/FullTcpX set ecn_syn_ false; # Make SYN/ACK packet ECN-Capable?\n\
Agent/TCPX/FullTcpX set ecn_syn_wait_ 0; # Wait after marked SYN/ACK? \n\
Agent/TCPX/FullTcpX set debug_ false;  # Added Sept. 16, 2007.\n\
\n\
Agent/TCPX/FullTcpX/NewrenoX set recov_maxburst_ 2; # max burst dur recov\n\
\n\
Agent/TCPX/FullTcpX/SackX set sack_block_size_ 8; # bytes in a SACK block\n\
Agent/TCPX/FullTcpX/SackX set sack_option_size_ 2; # bytes in opt hdr\n\
Agent/TCPX/FullTcpX/SackX set max_sack_blocks_ 3; # max # of sack blks\n\
Agent/TCPX/FullTcpX/SackX set clear_on_timeout_ true; # clear sq at sender on timeout?\n\
Agent/TCPX/FullTcpX/SackX set sack_rtx_cthresh_ 1; # dup cnt to trigger rtx\n\
Agent/TCPX/FullTcpX/SackX set sack_rtx_bthresh_ 1; # dup bcnt to trigger rtx\n\
Agent/TCPX/FullTcpX/SackX set sack_rtx_threshmode_ 1; # 1 = cnt only\n\
\n\
Agent/TCPX/FullTcpX/TahoeX instproc init {} {\n\
\n\
$self next\n\
$self instvar reno_fastrecov_\n\
set reno_fastrecov_ false\n\
...
\n\
Agent/TCPX/FullTcpX/SackX instproc init {} {\n\
$self next\n\
$self instvar reno_fastrecov_ open_cwnd_on_pack_\n\
set reno_fastrecov_ false\n\
set open_cwnd_on_pack_ false\n\
...
\n\
\n\
Agent/TCPX/FullTcpX/NewrenoX instproc init {} {\n\
$self next\n\
$self instvar open_cwnd_on_pack_\n\
set open_cwnd_on_pack_ false\n\
}\n\
