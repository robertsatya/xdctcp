...
l = listdir('/usr/local/home/cse222a19/ucsdcse222a/group19/src/sim1_1203/3_3_avg/')
#
...
#p_list = []
#for file_name in l:
#    with open('/usr/local/home/cse222a19/ucsdcse222a/group19/src/sim1_1203/2_5_avg/' + file_name, 'r') as f:
#        s = f.read()
...
for file_name in l:
    with open('/usr/local/home/cse222a19/ucsdcse222a/group19/src/sim1_1203/3_3_avg/' + file_name, 'r') as f:
        s = f.read()
        s_lines = s.strip().split('\n')
        params = s_lines[0].strip().split()
        #if params[0] == "0.095000000000000001":
        if params[0] == "0.089999999999999997":
...
#plot_url = py.plot(data, filename='thr-heatmap-3-3')
plot_url = py.plot(data, filename='delay-heatmap-3-3')
